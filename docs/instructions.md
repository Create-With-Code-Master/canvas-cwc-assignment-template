...
<ol>
    <li>Make sure that your <b>{{site.data.assignment.starter-code-repo}}</b> repository is selected.</li>
    ...
    <li>Make sure that you are on the {{site.data.assignment.get-prev-branch}} branch.</li>
</ol>
